        ...
        <>
          ...
          <img
            ...
            onError={(e) => { 
              ...
              e.currentTarget.src = "data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='400' height='400' viewBox='0 0 400 400'%3E%3Crect width='100%25' height='100%25' fill='%230f172a'/%3E%3Ctext x='50%25' y='50%25' font-family='sans-serif' font-size='24' fill='%23475569' text-anchor='middle' dy='.3em'%3Eไม่มีสัญญาณภาพ%3C/text%3E%3C/svg%3E"; 
              setImgError(true); 
            }}
          />
        </>
